...
* Parsing function for single TFRecordDataset record:
  Create dictionary {feature/label: tf.FixedLenFeature/VarLenFeature}, call tf.parse_single_example(record, dictionary), return ({features: values}, label)
...
#  LocalWords:  bucketized fpr tpr NP wrt pca SVD TFRecordDataset
#  LocalWords:  TFRecord dict DNNClassifier keras crvnf versioning
#  LocalWords:  overgeneralization MUCBOMS FixedLenFeature dtype
#  LocalWords:  VarLenFeature ROSOCA
