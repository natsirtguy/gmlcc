...
* Prediction bias:
  Difference between average of things we predict and average of things we observe
* Harmonic mean:
...
* Create feature column called "pixels" that will hold arrays with len 1600:
  tf.feature_column.numeric_column("pixels", 1600)
...
#  LocalWords:  DDNRegressor memoizing Adagrad Softmax
